...
update_option( 'revslider-code', '09f3a00a-d451-46d0-b200-f33fb09fcdf5' );
update_option( 'revslider-deregister-popup', 'false');
define('RS_REVISION',			'6.7.13');
...
define('RS_TP_TOOLS',			'6.7.13'); //holds the version of the tp-tools script, load only the latest!
