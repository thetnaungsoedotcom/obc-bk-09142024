...
<?php global $post_type; ?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<?php elseif ( comments_open() || in_array($post_type, array(EVENT_TYPE)) ) : ?>  
		
			<div class="module module-facebook-comments">
				<h2 class="divider-heading">Comments</h2>
				<div class="module-facebook-comments-wrapper">
					<div class="fb-comments" data-href="<?php the_permalink() ?>" data-num-posts="1" data-width="580"></div>
				</div>
			</div>
